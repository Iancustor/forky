...
export default function page() {
  ...
  return (
    <div className="flex flex-col  max-w-[85%] min-h-screen m-auto rounded-xl  bg-violet-100 ">
      {/* HEADER */}
      <div className="flex rounded  bg-violet-100 py-5   px-10 items-center justify-between gap-16 ">
        <div className="flex items-center">
          <div className="lg:w-14 md:w-9 sm:w-7 rounded-3xl ">
            <Image src={ImageEl} alt="png" className="rounded-full " />
          </div>
          <h2 className="lg:text-2xl md:text-xl font-serif font-bold">Forky</h2>
        </div>
        <form
          className="flex lg:w-[30rem] w-[10rem] bg-slate-50 rounded-l-3xl rounded-r-3xl gap-3"
        ...
        >
          <input
            ...
            className="flex bg-slate-50 lg:w-full items-start rounded-l-3xl outline-none px-6 py-2 "
          />

          <button
            type="submit"
            className="flex items-center justify-center rounded-t-3xl rounded-b-3xl gap-2 lg:w-[150px] bg-violet-400 px-2 py-2"
          >
            {" "}
            <Search className="" />
            search
        ...
        <div className="lg:flex gap-8 md:flex hidden">
          <li className="flex gap-2 decoration-none font-semibold">
            ...
            <button className="flex text-[10px] lg:text-[1rem]">
              ADD RECIPE
            </button>
          </li>
          <li className="flex gap-2 decoration-none font-semibold">
            <Bookmark className="text-violet-800 font-extrabold" />
            <button className="flex text-[10px] lg:text-[1rem]">BOOKMARKS</button>
          </li>
        </div>
      </div>

      <div className="flex gap-4  w-[100%] min-h-screen">
        <div className="flex py-6 px-12 justify-start w-[35%] min-h-screen bg-violet-50">
        ...
        <div className="flex py-14 justify-center w-[55%] h-[100vh] bg-violet-100">
          <p className=" flex gap-3 text-xl ">
            <AlertTriangle className="text-red-500 " />
            We could not find that recipie <br />
